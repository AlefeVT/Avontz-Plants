  ...
  return (
    <div className="relative overflow-x-clip">
      ...
      <section className="bg-white dark:bg-gray-900 py-24">
        ...
        <p className="text-4xl text-center max-w-xl mx-auto mb-12">
          <span className="rotate-3 text-blue-300">Confie em mim...</span> você
          vai querer um kit de inicialização. É por isso que estou usando isso
          para todos os meus produtos SaaS.
        </p>
